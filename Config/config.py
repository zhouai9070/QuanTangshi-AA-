...
class Configurable(myconf):
    ...
    @property
    def model_cnn1(self):
        return self._config.getboolean("Model", "model_cnn1")

    @property
    def model_transformer(self):
        return self._config.getboolean("Model", "model_transformer")

    @property
    def model_attcnn(self):
        return self._config.getboolean("Model", "model_attcnn")

    @property
    def model_deepcnn(self):
        return self._config.getboolean("Model", "model_deepcnn")

    @property
    def model_multicnn(self):
        return self._config.getboolean("Model", "model_multicnn")

    @property
    def model_cnn_bilstm(self):
        return self._config.getboolean("Model", "model_cnn_bilstm")

    @property
    def model_highwaycnn(self):
        return self._config.getboolean("Model", "mode1_highwaycnn")
    ...
    @property
    def model_attbilstm(self):
        return self._config.getboolean("Model", "model_attbilstm")
